...
//! - Stack maps serialized to `.gox_stackmap` section in .o file
...
///
/// This will be written to a `.gox_stackmap` section in the .o file.
/// Format:
/// ```text
/// magic: u32 = 0x474F5853 ("GOXS")
/// version: u32 = 1
/// num_functions: u32
/// [
...
pub mod aot {
    ...
    /// Magic number for stack map section: "GOXS"
    ...
    ///
    /// # Returns
    /// Serialized bytes to write to `.gox_stackmap` section
    ///
    ...
    ///
    /// # Arguments
    /// * `data` - Raw bytes from `.gox_stackmap` section
    ///
    /// # Returns
