...
/// Debug print a value.
/// extern "C" fn gox_debug_print(value: u64, type_tag: u8)
#[no_mangle]
pub extern "C" fn gox_debug_print(value: u64, type_tag: u8) {
...
/// extern "C" fn gox_assert_begin(condition: u64, arg_count: u64, line: u64) -> u8
#[no_mangle]
pub extern "C" fn gox_assert_begin(condition: u64, arg_count: u64, line: u64) -> u8 {
    if condition != 0 {
        // Assertion passed
...
/// extern "C" fn gox_assert_arg(value: u64, type_tag: u8)
#[no_mangle]
pub extern "C" fn gox_assert_arg(value: u64, type_tag: u8) {
...
/// extern "C" fn gox_assert_end()
#[no_mangle]
pub extern "C" fn gox_assert_end() {
    let failed = ASSERT_FAILED.with(|f| f.load(Ordering::SeqCst));
    if failed {
...
mod tests {
    ...
    fn test_assert_pass() {
        ...
        let result = gox_assert_begin(1, 0, 10);
        assert_eq!(result, 1);
    }
}
