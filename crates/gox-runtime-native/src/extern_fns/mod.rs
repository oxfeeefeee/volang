...
pub fn register_all(register: &mut dyn FnMut(&str, ExternDispatchFn)) {
    ...
    register("strings.ToLower", |args, rets| {
        ...
        crate::gc_global::with_gc(|gc| {
            rets[0] = unsafe { strings::gox_strings_to_lower(gc, s) } as u64;
        });
        Ok(())
    });
    register("strings.ToUpper", |args, rets| {
        let s = args[0] as gox_runtime_core::gc::GcRef;
        crate::gc_global::with_gc(|gc| {
            rets[0] = unsafe { strings::gox_strings_to_upper(gc, s) } as u64;
        });
        Ok(())
    });
    register("strings.TrimSpace", |args, rets| {
        let s = args[0] as gox_runtime_core::gc::GcRef;
        crate::gc_global::with_gc(|gc| {
            rets[0] = unsafe { strings::gox_strings_trim_space(gc, s) } as u64;
        });
        Ok(())
    });
    register("strings.Trim", |args, rets| {
        ...
        crate::gc_global::with_gc(|gc| {
            rets[0] = unsafe { strings::gox_strings_trim(gc, s, cutset) } as u64;
        });
        Ok(())
    });
    register("strings.Repeat", |args, rets| {
        ...
        let n = args[1] as i64;
        crate::gc_global::with_gc(|gc| {
            rets[0] = unsafe { strings::gox_strings_repeat(gc, s, n) } as u64;
        });
        Ok(())
    });
    register("strings.Replace", |args, rets| {
        ...
        let n = args[3] as i64;
        crate::gc_global::with_gc(|gc| {
            rets[0] = unsafe { strings::gox_strings_replace(gc, s, old, new, n) } as u64;
        });
        Ok(())
    });
    register("strings.Split", |args, rets| {
        ...
        crate::gc_global::with_gc(|gc| {
            ...
            rets[0] = unsafe { strings::gox_strings_split(gc, s, sep) } as u64;
        });
        Ok(())
    });
    register("strings.SplitN", |args, rets| {
        ...
        let n = args[2] as i64;
        crate::gc_global::with_gc(|gc| {
            rets[0] = unsafe { strings::gox_strings_split_n(gc, s, sep, n) } as u64;
        });
        Ok(())
    });
    register("strings.Join", |args, rets| {
        ...
        let sep = args[1] as gox_runtime_core::gc::GcRef;
        crate::gc_global::with_gc(|gc| {
            rets[0] = unsafe { strings::gox_strings_join(gc, parts, sep) } as u64;
        });
        Ok(())
    });
    ...
    register("strconv.Atoi", |args, rets| {
        let s = args[0] as gox_runtime_core::gc::GcRef;
        crate::gc_global::with_gc(|gc| {
            let result = unsafe { strconv::gox_strconv_atoi(gc, s) };
    ...
    register("strconv.Itoa", |args, rets| {
        let n = args[0] as i64;
        crate::gc_global::with_gc(|gc| {
            rets[0] = unsafe { strconv::gox_strconv_itoa(gc, n) } as u64;
        });
        Ok(())
    });
    register("strconv.ParseInt", |args, rets| {
        ...
        crate::gc_global::with_gc(|gc| {
            let result = unsafe { strconv::gox_strconv_parse_int(gc, s, base) };
    ...
    register("strconv.ParseFloat", |args, rets| {
        let s = args[0] as gox_runtime_core::gc::GcRef;
        crate::gc_global::with_gc(|gc| {
            let result = unsafe { strconv::gox_strconv_parse_float(gc, s) };
    ...
    register("strconv.FormatInt", |args, rets| {
        ...
        let base = args[1] as i64;
        crate::gc_global::with_gc(|gc| {
            rets[0] = unsafe { strconv::gox_strconv_format_int(gc, n, base) } as u64;
        });
        Ok(())
    });
    register("strconv.FormatFloat", |args, rets| {
        ...
        crate::gc_global::with_gc(|gc| {
            rets[0] = unsafe { strconv::gox_strconv_format_float(gc, f, fmt as u8, prec) } as u64;
        });
        Ok(())
    });
    register("strconv.FormatBool", |args, rets| {
        let b = args[0] != 0;
        crate::gc_global::with_gc(|gc| {
            rets[0] = unsafe { strconv::gox_strconv_format_bool(gc, b) } as u64;
        });
        Ok(())
    });
    register("strconv.ParseBool", |args, rets| {
        let s = args[0] as gox_runtime_core::gc::GcRef;
        crate::gc_global::with_gc(|gc| {
            let result = unsafe { strconv::gox_strconv_parse_bool(gc, s) };
    ...
    register("strconv.Quote", |args, rets| {
        let s = args[0] as gox_runtime_core::gc::GcRef;
        crate::gc_global::with_gc(|gc| {
            rets[0] = unsafe { strconv::gox_strconv_quote(gc, s) } as u64;
        });
        Ok(())
    });
    ...
    register("hex.EncodeToString", |args, rets| {
        ...
        crate::gc_global::with_gc(|gc| {
            rets[0] = unsafe { hex::gox_hex_encode_to_string(gc, src) } as u64;
        });
        Ok(())
    });
    register("hex.DecodeString", |args, rets| {
        let s = args[0] as gox_runtime_core::gc::GcRef;
        crate::gc_global::with_gc(|gc| {
            let result = unsafe { hex::gox_hex_decode_string(gc, s) };
    ...
    register("base64.EncodeToString", |args, rets| {
        let src = args[0] as gox_runtime_core::gc::GcRef;
        crate::gc_global::with_gc(|gc| {
            rets[0] = unsafe { base64::gox_base64_std_encode(gc, src) } as u64;
        });
        Ok(())
    });
    register("base64.URLEncodeToString", |args, rets| {
        let src = args[0] as gox_runtime_core::gc::GcRef;
        crate::gc_global::with_gc(|gc| {
            rets[0] = unsafe { base64::gox_base64_url_encode(gc, src) } as u64;
        });
        Ok(())
    });
    register("base64.DecodeString", |args, rets| {
        let s = args[0] as gox_runtime_core::gc::GcRef;
        crate::gc_global::with_gc(|gc| {
            let result = unsafe { base64::gox_base64_std_decode(gc, s) };
            rets[0] = result.0 as u64;  // bytes slice
            rets[1] = result.1 as u64;  // error string
        });
        Ok(())
    ...
    register("base64.RawEncodeToString", |args, rets| {
        let src = args[0] as gox_runtime_core::gc::GcRef;
        crate::gc_global::with_gc(|gc| {
            rets[0] = unsafe { base64::gox_base64_raw_encode(gc, src) } as u64;
        });
        Ok(())
    });
    register("base64.URLDecodeString", |args, rets| {
        let s = args[0] as gox_runtime_core::gc::GcRef;
        crate::gc_global::with_gc(|gc| {
            let result = unsafe { base64::gox_base64_url_decode(gc, s) };
            rets[0] = result.0 as u64;
            rets[1] = result.1 as u64;
        });
        Ok(())
    ...
    register("regexp.MatchString", |args, rets| {
        ...
        crate::gc_global::with_gc(|gc| {
            let result = unsafe { regexp::gox_regexp_match_string(gc, pattern, s) };
            rets[0] = if result.0 { 1 } else { 0 };
            rets[1] = result.1 as u64;  // error
        });
        Ok(())
