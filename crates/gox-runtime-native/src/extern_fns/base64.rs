...
#[no_mangle]
pub unsafe extern "C" fn gox_base64_std_encode(gc: *mut Gc, src: GcRef) -> GcRef {
...
#[no_mangle]
pub unsafe extern "C" fn gox_base64_raw_encode(gc: *mut Gc, src: GcRef) -> GcRef {
    let src_bytes = slice_to_bytes(src);
...
#[no_mangle]
pub unsafe extern "C" fn gox_base64_url_encode(gc: *mut Gc, src: GcRef) -> GcRef {
    let src_bytes = slice_to_bytes(src);
