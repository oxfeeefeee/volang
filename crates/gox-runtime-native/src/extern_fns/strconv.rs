...
#[no_mangle]
pub unsafe extern "C" fn gox_strconv_atoi(gc: *mut Gc, s: GcRef) -> (i64, GcRef) {
...
#[no_mangle]
pub unsafe extern "C" fn gox_strconv_itoa(gc: *mut Gc, n: i64) -> GcRef {
    string::from_rust_str(&mut *gc, &core::itoa(n))
}

#[no_mangle]
pub unsafe extern "C" fn gox_strconv_parse_int(gc: *mut Gc, s: GcRef, base: i64) -> (i64, GcRef) {
...
#[no_mangle]
pub unsafe extern "C" fn gox_strconv_parse_float(gc: *mut Gc, s: GcRef) -> (f64, GcRef) {
...
#[no_mangle]
pub unsafe extern "C" fn gox_strconv_format_int(gc: *mut Gc, n: i64, base: i64) -> GcRef {
    string::from_rust_str(&mut *gc, &core::format_int(n, base))
}

#[no_mangle]
pub unsafe extern "C" fn gox_strconv_format_float(gc: *mut Gc, f: f64, fmt: u8, prec: i64) -> GcRef {
    string::from_rust_str(&mut *gc, &core::format_float(f, fmt as char, prec))
}

#[no_mangle]
pub unsafe extern "C" fn gox_strconv_format_bool(gc: *mut Gc, b: bool) -> GcRef {
    string::from_rust_str(&mut *gc, &core::format_bool(b))
}

#[no_mangle]
pub unsafe extern "C" fn gox_strconv_parse_bool(gc: *mut Gc, s: GcRef) -> (bool, GcRef) {
...
#[no_mangle]
pub unsafe extern "C" fn gox_strconv_quote(gc: *mut Gc, s: GcRef) -> GcRef {
