...
#[no_mangle]
pub unsafe extern "C" fn gox_strings_trim_space(gc: *mut Gc, s: GcRef) -> GcRef {
    let result = core::trim_space(string::as_str(s));
    string::from_rust_str(&mut *gc, result)
}

#[no_mangle]
pub unsafe extern "C" fn gox_strings_trim(gc: *mut Gc, s: GcRef, cutset: GcRef) -> GcRef {
...
#[no_mangle]
pub unsafe extern "C" fn gox_strings_repeat(gc: *mut Gc, s: GcRef, n: i64) -> GcRef {
