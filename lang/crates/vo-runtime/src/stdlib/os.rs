...
use vo_ffi_macro::{vostd_extern_ctx, vo_errors, vo_consts};
...
// Os sentinel errors - generated by vo_errors! macro
// Works in both std and no_std (distributed_slice only in std)
vo_errors! {
    internal "os" => {
